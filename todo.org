...
*** PROG [4/5] Write Elisp for Workflow
:PROPERTIES:
...
**** PROG Automatically Mark Task as Done Once Children are Done
:PROPERTIES:
...
** NEXT Come Up With System for Refiling
:PROPERTIES:
