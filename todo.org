...
* PROG [4/5] Initial Documentation
:PROPERTIES:
...
** NEXT Get Reacquainted with Verilog
:PROPERTIES:
...
Use [[https://hdlbits.01xz.net/wiki/Main_Page][hdlbits]] for this
